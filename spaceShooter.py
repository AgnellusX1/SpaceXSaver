...
def main_menu():
    ...
    title = pygame.image.load(path.join(img_dir, "asdf.png")).convert()
...
background = pygame.image.load(path.join('moon.png')).convert()
background_rect = background.get_rect()
## ^^ draw this rect first 

player_img = pygame.image.load(path.join('falcon.png')).convert()
player_mini_img = pygame.transform.scale(player_img, (25, 19))
player_mini_img.set_colorkey(BLACK)
bullet_img = pygame.image.load(path.join('mis1.png')).convert()
missile_img = pygame.image.load(path.join('mis4.png')).convert_alpha()
